  ...
  const tools = [
    {
      ...
      url: `https://lead-qualifier-i0r3.onrender.com/get-available-slots?apiKey=${process.env.Bland_cal_key}&startTime=${input.startTime}&endTime=${input.endTime}&eventTypeId=896227&timeZone=Asia/Dubai`,
      method: "GET",
      headers: {
